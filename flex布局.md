...
```css
vw视口宽度单位 100vw = 实际图纸的宽度（页面大小设置）
flex-direction:row 弹性-方向：行
justify-content:flex-start // 对齐-内容：弹性 起点 如何分配主轴上的空白空间
align-content 辅轴空白空间的分布
align-items:stretch // 对齐-条目：拉伸 元素在辅轴上如何对齐 元素间的关系
flex-wrap 设置弹性元素是否在弹性容器中自动换行

语法：flex:增长 收缩 基础 表示的是当父元素有空白位置时子元素如何变化
flex-grow flex-shrink flex-basis 元素基础长度
